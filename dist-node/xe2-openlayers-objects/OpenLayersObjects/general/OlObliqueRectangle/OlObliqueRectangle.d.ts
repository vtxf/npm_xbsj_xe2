...
export declare class OlObliqueRectangle extends ESSceneObject {
...
export declare namespace OlObliqueRectangle {
...
export interface OlObliqueRectangle extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof OlObliqueRectangle.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof OlObliqueRectangle.createDefaultProps> & {
    type: string;
}>;
export {};

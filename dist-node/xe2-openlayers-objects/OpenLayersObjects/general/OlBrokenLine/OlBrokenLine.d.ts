...
export declare class OlBrokenLine extends ESSceneObject {
...
export declare namespace OlBrokenLine {
...
export interface OlBrokenLine extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof OlBrokenLine.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof OlBrokenLine.createDefaultProps> & {
    type: string;
}>;
export {};

 ...
 * @param fillStyle
 */
export declare function drawBubble(ctx: CanvasRenderingContext2D, mbx: number, mby: number, w: number, fillStyle: string): void;
/**
 *
 * @param ctx Context
 ...
 * @param fillStyle
 */
export declare function drawPoint(ctx: CanvasRenderingContext2D, centerX: number, centerY: number, radius: number, fillStyle: string): void;

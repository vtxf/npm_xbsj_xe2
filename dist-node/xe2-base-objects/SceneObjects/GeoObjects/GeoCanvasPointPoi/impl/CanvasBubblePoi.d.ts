...
export declare class CanvasBubblePoi extends CanvasPoi {
    private _width;
    private _text;
    private _fillStyle;
    private _scale;
    protected _scaleChanged?: Event<[number, CanvasBubblePoi]>;
     ...
     * d();
     */
    get scaleChanged(): Event<[number, CanvasBubblePoi]>;

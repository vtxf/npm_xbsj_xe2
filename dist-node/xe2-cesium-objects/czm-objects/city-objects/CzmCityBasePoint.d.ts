...
export declare class CzmCityBasePoint extends ESSceneObject {
...
export interface CzmCityBasePoint extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof CzmCityBasePoint.createDefaultProps> & typeof extraComponentProps> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof CzmCityBasePoint.createDefaultProps> & typeof extraComponentProps & {
    type: string;
}>;
export {};

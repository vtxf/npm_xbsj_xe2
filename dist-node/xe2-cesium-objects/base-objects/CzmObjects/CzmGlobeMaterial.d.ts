...
export declare class CzmGlobeMaterial extends ESSceneObject {
    ...
    get defaultProps(): {
        ...
        shadingMode: "none" | "elevation" | "slope" | "aspect" | undefined;
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof CzmGlobeMaterial.createDefaultProps> & {
    type: string;
}>;
export {};

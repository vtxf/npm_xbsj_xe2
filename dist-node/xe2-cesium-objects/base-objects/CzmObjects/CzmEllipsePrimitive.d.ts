...
export declare class CzmEllipsePrimitive extends ESSceneObject {
...
export declare namespace CzmEllipsePrimitive {
...
export interface CzmEllipsePrimitive extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof CzmEllipsePrimitive.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof CzmEllipsePrimitive.createDefaultProps> & {
    type: string;
}>;
export {};

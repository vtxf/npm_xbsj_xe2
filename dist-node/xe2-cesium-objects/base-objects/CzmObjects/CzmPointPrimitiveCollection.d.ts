...
import { NativeNumber16Type, CzmPointPrimitiveType } from "xbsj-xe2/dist-node/xe2-base-objects";
import { ESSceneObject } from "xbsj-xe2/dist-node/xe2-base-objects";
export declare class CzmPointPrimitiveCollection extends ESSceneObject {
...
export interface CzmPointPrimitiveCollection extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof CzmPointPrimitiveCollection.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof CzmPointPrimitiveCollection.createDefaultProps> & {
    type: string;
}>;
export {};

...
export declare class CzmPolygonPrimitive extends ESSceneObject {
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof CzmPolygonPrimitive.createDefaultProps> & {
    type: string;
}>;
export {};

...
export declare class CzmSmokeParticleSystem extends ESSceneObject {
...
export declare namespace CzmSmokeParticleSystem {
...
export interface CzmSmokeParticleSystem extends ReactivePropsToNativePropsAndChanged<ReturnType<typeof CzmSmokeParticleSystem.createDefaultProps>> {
}
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof CzmSmokeParticleSystem.createDefaultProps> & {
    type: string;
}>;
export {};

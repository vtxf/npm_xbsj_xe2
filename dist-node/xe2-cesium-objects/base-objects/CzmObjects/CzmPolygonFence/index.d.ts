...
export declare class CzmPolygonFence extends ESSceneObject {
    ...
    get geoBoundingSphere(): import("xbsj-xe2/dist-node/xe2-base-objects").GeoBoundingSphereType | undefined;
    get geoBoundingSphereChanged(): Listener<[import("xbsj-xe2/dist-node/xe2-base-objects").GeoBoundingSphereType | undefined, import("xbsj-xe2/dist-node/xe2-base-objects").GeoBoundingSphereType | undefined]>;
...
declare type JsonType = PartialWithUndefinedReactivePropsToNativeProps<ReturnType<typeof CzmPolygonFence.createDefaultProps> & {
    type: string;
}>;
export {};
